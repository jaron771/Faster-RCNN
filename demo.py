...
COLOR=['red','white','blue','black','gray','orange','green','pink','cyan']
FACE=['blue','black','green','white','orange','blue','cyan','red','pink']

CLASSES = ('__background__',  # always index 0
                         'button','imgbutton','textview','checkbox','radiobutton','checkboxs','imgview','nav','alert')

NETS = {'vgg16': ('vgg16_faster_rcnn_iter_500.ckpt',), 'res101': ('res101_faster_rcnn_iter_110000.ckpt',)}
