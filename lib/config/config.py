...
tf.app.flags.DEFINE_integer('max_iters', 500, "Max iteration")
tf.app.flags.DEFINE_integer('step_size', 300, "Step size for reducing the learning rate, currently only support one step")
